...
export default async function CurrencyLayout({
  ...
  const pathname = `/${locale}/currency`;

  // FAQ 구조화된 데이터 생성
  const faqQuestions = [
    {
      "@type": "Question",
      name: t("currency.seo.faq1.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("currency.seo.faq1.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("currency.seo.faq2.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("currency.seo.faq2.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("currency.seo.faq3.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("currency.seo.faq3.answer"),
      },
    },
  ];
