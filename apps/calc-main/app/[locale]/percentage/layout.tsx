...
export default async function PercentageLayout({
  ...
  const pathname = `/${locale}/percentage`;

  // FAQ 구조화된 데이터 생성
  const faqQuestions = [
    {
      "@type": "Question",
      name: t("percentage.seo.faq1.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("percentage.seo.faq1.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("percentage.seo.faq2.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("percentage.seo.faq2.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("percentage.seo.faq3.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("percentage.seo.faq3.answer"),
      },
    },
  ];
  ...
  const appData = {
    ...
    description: t("percentage.subtitle"),
    rating: {
      value: "4.8",
      count: "1800",
    },
