...
export default async function ColorLayout({
  ...
  const pathname = `/${locale}/color`;

  // FAQ 구조화된 데이터 생성
  const faqQuestions = [
    {
      "@type": "Question",
      name: t("color.seo.faq1.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("color.seo.faq1.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("color.seo.faq2.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("color.seo.faq2.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("color.seo.faq3.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("color.seo.faq3.answer"),
      },
    },
  ];
