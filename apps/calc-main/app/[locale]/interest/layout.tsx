...
export default async function InterestLayout({
  ...
  const pathname = `/${locale}/interest`;

  // FAQ 구조화된 데이터 생성
  const faqQuestions = [
    {
      "@type": "Question",
      name: t("interest.seo.faq1.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("interest.seo.faq1.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("interest.seo.faq2.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("interest.seo.faq2.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("interest.seo.faq3.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("interest.seo.faq3.answer"),
      },
    },
  ];
  ...
  const appData = {
    name: t("interest.title"),
    description: t("interest.subtitle"),
    rating: {
      value: "4.7",
      count: "1600",
    },
