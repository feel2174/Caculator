...
export default async function BMILayout({
  children,
  params,
}: {
  ...
  const pathname = `/${locale}/bmi`;

  // FAQ 구조화된 데이터 생성
  const faqQuestions = [
    {
      "@type": "Question",
      name: t("bmi.seo.faq1.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("bmi.seo.faq1.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("bmi.seo.faq2.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("bmi.seo.faq2.answer"),
      },
    },
    {
      "@type": "Question",
      name: t("bmi.seo.faq3.question"),
      acceptedAnswer: {
        "@type": "Answer",
        text: t("bmi.seo.faq3.answer"),
      },
    },
  ];
